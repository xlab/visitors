...
int Config_max_google_keyphrases = 100;
int Config_max_google_keyphrases_age = 100;
int Config_max_yandex_keyphrases = 100;
int Config_max_yandex_keyphrases_age = 100;
...
int vi_process_browsers(struct vih *vih, char *agent)
{
	...
	char *browserslist[] = {
		...
		"Konqueror", NULL,
		"Dillo", NULL,
		"IEMobile", "Mobile Internet Explorer",
		"MSIE 4", "Explorer 4.x",
		"MSIE 5", "Explorer 5.x",
		"MSIE 6", "Explorer 6.x",
		"MSIE 7", "Explorer 7.x",
